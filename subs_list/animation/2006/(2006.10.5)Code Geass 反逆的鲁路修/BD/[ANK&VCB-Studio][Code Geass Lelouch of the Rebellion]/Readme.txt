此版本我只改名匹配vcb的版本，以下为原版本说明



***本版本只調校繁體版的時間軸***
上传：Nox（伪射手网）
基於[異域-11番小隊]所整合的字幕再調校時間軸
適用於[ANK&VCB-S&philosophy-raws](雖然已有內嵌字幕)
不確定是否能用於[VCB-Studio&ANK-Raws]和[philosophy-raws](应该可以匹配）

部分OVA字幕來自其他翻譯組
部分Picture Drama找不到字幕
